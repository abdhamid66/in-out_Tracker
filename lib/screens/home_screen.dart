...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void _refreshData() async {
    ...
    if (bulanTerpilih == 'Bulan Ini') {
      ...
      int tahunSekarang =
          DateTime.now().year; // Kita asumsikan pakai tahun saat ini
  ...
  Future<void> _eksporKeExcel() async {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(
        content: Text('Sedang membuat file Excel...'),
    ...
    try {
      ...
      for (var item in data) {
        ...
        sheet.appendRow([
          ...
          IntCellValue(
            item.nominal.toInt(),
          ), // Angka murni biar bisa dijumlah pakai rumus di Excel
        ]);
      }
  ...
  void _tampilkanDialogUbahPin() {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text(
          'Apakah kamu yakin ingin mengatur ulang (mengubah) PIN aplikasi? Kamu akan diminta membuat 4 digit PIN baru.',
        ),
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () async {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(
                  content: Text('Silakan buat PIN baru kamu'),
                  backgroundColor: Color(0xFF138D75),
                ),
              );
            },
          ...
          builder: (context) {
            return IconButton(
              ...
              onPressed: () {
                Scaffold.of(
                  context,
                ).openDrawer(); // Perintah untuk membuka laci
              },
            );
          },
        ),
            ...
            ListTile(
              ...
              onTap: () {
                ...
                showAboutDialog(
                  ...
                  children: const [
                    Text(
                      'Aplikasi catatan keuangan pribadi untuk melacak pemasukan dan pengeluaran secara lokal dan aman.',
                    ),
                  ],
                );
              },
                  ...
                  Container(
                    ...
                    child: DropdownButtonHideUnderline(
                      child: DropdownButton<String>(
                        ...
                        onChanged: (String? nilaiBaru) {
                          if (nilaiBaru != null) {
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(
                              SnackBar(
                                content: Text(
                                  'Menyiapkan data bulan: $nilaiBaru...',
                                ),
                        ...
                        items: daftarBulan.map<DropdownMenuItem<String>>((
                          String namaBulan,
                        ) {
          ...
          child: Row(
            ...
            children: [
              ...
              IconButton(
                ...
                onPressed: () {
                  // Pindah ke Halaman Profil yang baru kita buat
                  Navigator.push(
                    context,
                    MaterialPageRoute(
